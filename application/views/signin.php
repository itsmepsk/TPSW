			...
			<div class="box_style_2">
					...
					<br><br>
                                ...
                                <div align="center"
                                    ...
                                    <span style='color: red'> 
                                        <b>Invalid Roll No. or Password <br><br></b>
                                    </span>
                                </div>
                            <?php
                                $class = array(
				...
				<?php echo form_open(base_url()."login/validate/",$class); ?>
					<div id="loginform" 
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
                                                            ...
                                                            <span style='color: red;'> 
                                                                <b><?php echo form_error('roll_no','<div class="error">', '</div>')?></b>
                                                            </span>
                                                            <span id="roll_error" style='color: red; display: none'> 
                                                                <b>Roll No. must be of format 12/IT/48 </b>
                                                            </span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8"> 
                                                            ...
                                                            <span style='color: red;'> 
                                                                <b><?php echo form_error('password','<div class="error">', '</div>')?></b>
                                                            </span>
                                                            <span id="pwd_error" style='color: red; display: none'> 
                                                                <b>Password must be alphanumeric and may contain only these special characters _@ </b>
                                                            </span>
							</div>
						</div>
						<div class="form-group"> 
					...
					<div id="buttonfp"
                                            ...
                                            ?>
                                        >	
						<input type="submit" name = "login_submit" value = "Login" class="btn btn-primary col-lg-offset-2" onclick="isvalid()">
                                                <br><br>
						<p class="col-lg-offset-2"><a  href = "#" id= "forget" onclick=show('comment')>Forgot Password?</a></p>
					</div>
                                    <?php echo form_close(); ?>
						...
						<span id="comment" 
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
                                                                    ...
                                                                    <span style='color: red;'> 
                                                                        <b><?php echo form_error('reset_email','<div class="error">', '</div>')?>
                                                                            <?php
								...
								<div class=" col-lg-offset-1 col-lg-9">
									...
									<button type="button" class="btn btn3" onclick=hide('comment') value="Cancel">Cancel</button>
								</div>
							</div>
						</span>
					</div>
