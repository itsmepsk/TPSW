				...
				<div id="newpic" style=display:none>
					...
					<?php echo form_open(base_url().'details/submit',$attributes); ?>
						...
						<div class="input-append">
							...
							<a href=<?php echo base_url()."details/delete"; ?> id= "trash"data-toggle="tooltip" title="Delete image" onclick="return window.confirm('Do you really want to delete your photo?')">
						...
						<div class="input-append">
							...
							<button type="button" id = "cancelpic" onclick="show('picture','newpic')" class="btn btn-default right0">Cancel</button>
						</div>
					<?php echo form_close(); ?>
					<br><br>
				</div>
				...
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							...
							<div class="panel-body saman">
                               <?php
								...
								>
									...
									<div class="form-group">
										<label class="control-label col-lg-3 col-md-3 col-sm-3 namkaran">Current Semester:</label>
										<div class="col-lg-8"><?php echo form_dropdown("current_sem", $f_current_sem,$f_data['current_sem'],'class = "form-control" id = "cur_sem"'); ?></div>
									</div>
									<span style='color: red;text-align: center'> 
									...
									<div class="form-group">
										<label class="control-label col-lg-3 col-md-3 col-sm-3 namkaran">Sex:</label>
										<div class="col-lg-8"><?php echo form_dropdown("sex", $f_sex,$f_data['sex'],'class = "form-control" id= "sex"'); ?></div>
									</div>
									<span style='color: red;text-align: center'> 
							...
							<div class="panel-body saman">
								...
								<div>
									...
									>
										...
										<div class="row">
											<label class = "control-label col-lg-3 col-md-3 col-sm-3 namkaran">Supplies till <?php if (isset($f_current_sem[$f_data['current_sem']])){echo $f_current_sem[$f_data['current_sem']-1];}else {echo "current";} ?> Sem:</label>
						...
						" role="tabpanel" aria-labelledby="headingFive">
							<div class="panel-body saman">
								...
								>
									...
									<div>
										<button type="submit" name = "update_personal" id="personalupdate" value = "update_personal" class="btn btn-primary col-lg-offset-2">Update</button>
					...
					<div class="panel panel-default">
                        ...
                        " role="tabpanel" aria-labelledby="headingSeven">
							<div class="panel-body saman">
								<div>
									<p><b>Personalised Resume</b></p>
									<?php echo form_open(base_url().'details/submit',$class); ?>
									<?php echo form_input($f_cv); ?>
									<a class="btn" onclick="$('input[id=lecv]').click();" type="file" accept=".pdf"><img src=<?php echo base_url()."static/images/up1.png"; ?> width=50px></a>
									<a class="btn" href=<?php echo base_url()."static/files/resume.pdf"; ?> download><img src=<?php echo base_url()."static/images/down1.png"; ?> width=50px></a>
									<a class="btn" href=<?php echo base_url()."static/files/resume.pdf"; ?> target="_blank"><img src=<?php echo base_url()."static/images/view.png"; ?> width=50px></a>
									<?php echo form_close(); ?>
								</div>
								<div>
									<p><b>College CV</b></p>
