...
<html>
	...
	<div>
		<div class="container">
			<div class="col-lg-12 text-center written">	
				<br><br>
				<h2><strong>THE TEAM</strong></h2>
				<!--<h4>The ones who don't study</h4>-->
				<br>
			</div>
			<div class="col-lg-3 col-md-3 text-center">
				<div class="box_style_3">
					<img src=<?php echo base_url()."static/images/prathamesh-img.jpg"; ?> class="img-circle styled" width=100%>
					<h3>Prathamesh Kakade</h3>
			...
			<div class="col-lg-3 col-md-3 text-center">
				<div class="box_style_3">
					<img src = <?php echo base_url()."static/images/sagar-img.jpg"; ?> class="img-circle styled" width=100%>
					<h3>Sagar Jain</h3>
					<h5>ECE 3<sup>rd</sup> Year</h5>
					<br>
					<ul class="social_team">
			...
			<div class="col-lg-3 col-md-3 text-center">
				<div class="box_style_3">
					<img src = <?php echo base_url()."static/images/gaurav-img.jpg"; ?> class="img-circle styled" width=100%>
					<h3>Gaurav Chandak</h3>
					<h5>IT 3<sup>rd</sup> Year</h5>
					<br>
					<ul class="social_team">
						<li>
			...
			<div class="col-lg-3 col-md-3 text-center">
				<div class="box_style_3">
					<img src = <?php echo base_url()."static/images/avinish-img.jpg"; ?> class="img-circle styled" width=100%>
					<h3>Avinish Chandra</h3>
					<h5>IT 3<sup>rd</sup> Year</h5>
					<br>
					<ul class="social_team">
						<li>
